...
1. Dynamic Container Control
2. Instant Figma Style Copy-Pasting to WordPress
3. Easy Switching with Toggle
4. Flexible Countdown Display
5. Show Matrices with Counter
6. Content Timeline for Organized Flow
...
* Added - All Child Block Parent settings control option
* Fixed - Price Menu Block issue
* Fixed - Unit value hide issue
* Fixed - Modal Block Copy/Paste Error
* Fixed - Notice Block issue
* Fixed - Form Builder Block Icon issue
* Fixed - Every Block Advance tab Width issue
* Fixed - Toggle Block issue
* Fixed - Carousel Block Slide Per View issue
* Fixed - Coupon Block Validation issue

= 1.5.6 - 26/11/2024 =
* Fixed - Image Hotspot Block PHP version compatibility issue

= 1.5.5 - 26/11/2024 =
* Added - New Info-box block
* Added - New Image-Hotspot block
* Fixed - Icon Block Copy/paste issue
* Fixed - Global Box Shadow

= 1.5.4 - 24/11/2024 =
* Fixed - Countdown Block Typography issue
* Fixed - Block Shadow transition not worked issue
* Fixed - Background Overlay Opacity issue
* Fixed - Range Control Unit issue

= 1.5.3 - 21/11/2024 =
* Fixed - Range Control & Unit Data Saved issue
* Fixed - Form Builder Editor form submit not disable issue

= 1.5.2 - 21/11/2024 =
* Fixed - Container Width issue 

= 1.5.1 - 20/11/2024 =
* Fixed - Block appender conflicts with multiple block 
* Fixed - Tabs Block editor show/hide issue
* Fixed - Toggle Block editor show/hide issue
* Fixed - Counter Block UI issue
* Update - Simple Menu & Mega Menu UI issue

= 1.5.0 - 18/11/2024 =
* Added - New Modal & Popup Builder
* Added - New Form Builder (Login, Register)
* Added - New Search Block
* Added - New Price List Block
* Added - New Progress Tracker Block
* Fixed - Academy Instructor Registration Block PHP undefined warning
* Fixed - Start Rating Block issue
* Fixed - List Block Block issue
* Fixed - Toggle Block hide issue
* Fixed - Academy PDF Block delete issue
* Fixed - Table Block checkbox ui issue
* Fixed - Tabs Block hide issue
* Fixed - Icon Uploader image upload issue


= 1.4.0 - 14/11/2024 =
* Added - New Table Block
* Added - New Simple & Mega Menu
* Added - aBlocks Pro Integration
* Fixed - Carousel Block issue
* Fixed - Text Shadow value showing issue
* Fixed - Accordion Block Advance padding not working
* Fixed - Countdown Block and UI issue
* Fixed - Toggle Block issue
* Fixed - Button Block issue
* Fixed - Image Block Image Ratio issue

= 1.3.2 - 06/11/2024 =
* Fixed - Icon & Button No follow link issue
* Fixed - Image Block custom URL issue
* Fixed - Divider Solid UI issue
* Fixed - Lint:Js & PHPCS issue

= 1.3.1 - 03/11/2024 =
* Improved - Figma to WordPress Copy / paste feature
* Fixed - Social share block conflicts with theme
* Fixed - List Block color conflicts with theme
* Fixed - Star Rating PHP Error
