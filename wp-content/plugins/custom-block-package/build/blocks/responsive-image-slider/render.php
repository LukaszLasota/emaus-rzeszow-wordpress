    ...
    <?php else : ?>
        ...
        <div class="glide__bullets" data-glide-el="controls[nav]">
            <?php for ($i = 0; $i < $valid_slides_count; $i++) : ?>
                <button class="glide__bullet" data-glide-dir="=<?php echo esc_attr($i); ?>" aria-label="<?php echo esc_attr(sprintf(__('Przejdź do slajdu %d', 'custom-block-package'), $i + 1)); ?>"></button>
            <?php endfor; ?>
        </div>
    <?php endif; ?> 
</div>