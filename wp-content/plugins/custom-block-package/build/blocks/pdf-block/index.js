...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"custom-block-package/pdf-block","title":"PDF Block","icon":"custom-blocks-from-scratch","category":"custom-blocks-from-scratch","description":"Dodaj pdf który wyświetli się na stronie.","keywords":["pdf"],"version":"1","textdomain":"pdf-block","attributes":{"pdfUrl":{"type":"string"},"pdfID":{"type":"number"},"pdfTitle":{"type":"string"},"btnTitle":{"type":"string"},"showDownload":{"type":"boolean"},"viewerHeight":{"type":"number"},"viewerWidth":{"type":"number"}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","viewStyle":"file:./style-index.css"}');
...
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index.scss */ "./src/blocks/pdf-block/index.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/pdf-block/style.scss");
...
/***/ "./src/blocks/pdf-block/index.scss":
/*!*****************************************!*\
  !*** ./src/blocks/pdf-block/index.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
